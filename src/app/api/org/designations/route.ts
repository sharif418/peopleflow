// GET /api/org/designations — list (with employee counts)
// POST /api/org/designations — create
import { db } from "@/lib/db"
import { ok, fail, requireOrg, isResponse, parseBody } from "@/lib/api-utils"
import { designationSchema, zodError } from "../_lib/schemas"
...
export async function POST(req: Request) {
  ...
  try {
    ...
    await audit(guard, "designation.created", "designation", created.id, name)
